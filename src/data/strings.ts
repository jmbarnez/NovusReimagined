...
export const STRINGS: Record<Language, Record<string, string>> = {
  en: {
    ...
    "tutorial.step.flyAcademy.objective": "Fly east to the Academy hub. Follow the guide lane, pass through boost gates, or open the system map ({mapKey}) and click the Academy to set a waypoint.",
    "tutorial.step.flyAcademy.hint": "Right-click ahead to set course. Aim between each gate's pillars for a boost. Press {brakeKey} to brake. Physics remains undefeated.",
