...
export const STRINGS: Record<Language, Record<string, string>> = {
  en: {
    ...
    "tutorial.step.scanSignature.objective": "Open the system map ({mapKey}), aim the scan cone at the southeast beacon sector, and pulse the scanner to resolve the training signature.",
    "tutorial.step.scanSignature.hint": "Press {mapKey} to open the map. Power the survey scanner in low slot 1 (hotkey 4), click near the beacon to aim the cone, then press Scan.",
    ...
    "tutorial.step.flySignature.hint": "The cross marker shows the resolved datacore location. Follow the lit corridor to reach it.",
    "tutorial.step.breachSignature.title": "Breach Datacore",
    "tutorial.step.breachSignature.objective": "Breach the training datacore by pressing {dockKey} near the marker or using the overview interaction.",
    "tutorial.step.breachSignature.hint": "Move into interact range of the signature marker and press {dockKey}. The datacore will attempt dignity. Ignore it.",
    ...
    "tutorial.hangar.combatLoadout.body": "Mining tools were useful in the belt. Gunnery needs the autocannon and salvager from cargo, so swap both high slots to the combat fit.",
