...
export const STRINGS: Record<Language, Record<string, string>> = {
  en: {
    ...
    "tutorial.step.flyStation.hint": "Fly the return spoke and use the boost gates. Once docked, Industry can refine your ore into usable bars. Rock goes in, less-rock comes out.",
    "tutorial.step.industry.title": "Industry Bench",
    "tutorial.step.industry.objective": "Dock at the Academy ({dockKey}), open Industry, choose Smelter, and queue Ferro bar refining.",
    "tutorial.step.industry.hint": "Open the Industry tab, select Smelter, then queue Ferro bar refining. The queue panel shows progress while the job runs.",
