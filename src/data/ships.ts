...
export const SHIPS: Record<string, ShipDef> = {
  scout: {
    ...
    render: {
      ...
      fill: "#182e42",
      stroke: "#38c0e0",
      nozzleOffsets: [[-16, -2], [-16, 2]],
      turretOffsets: [[7, -6], [7, 6]],
      cockpit: { cx: 9, cy: 0, rx: 3.5, ry: 2 },
      cockpitColor: "rgba(130,230,255,0.85)",
      sensorGlow: { x: 17, y: 0, r: 2.5, color: "rgba(80,180,255,0.40)" },
      decor: [
        { kind: "line", points: [[14, -1.8], [5, -2.8], [-8, -4.6]], color: "rgba(70,220,255,0.72)", width: 0.75 },
        { kind: "line", points: [[14, 1.8], [5, 2.8], [-8, 4.6]], color: "rgba(70,220,255,0.72)", width: 0.75 },
        { kind: "plate", points: [[3, -7.1], [-2, -7.8], [-5, -5.7], [-1, -4.8]], fill: "rgba(20,52,76,0.68)", stroke: "rgba(100,210,240,0.35)" },
        { kind: "plate", points: [[3, 7.1], [-2, 7.8], [-5, 5.7], [-1, 4.8]], fill: "rgba(20,52,76,0.68)", stroke: "rgba(100,210,240,0.35)" },
        { kind: "vent", x: -11.4, y: -2.7, w: 4.0, h: 1.5, count: 3, color: "rgba(8,18,28,0.72)" },
        { kind: "vent", x: -11.4, y: 1.2, w: 4.0, h: 1.5, count: 3, color: "rgba(8,18,28,0.72)" },
      ],
      panelLines: [
        [[16,0],[9,0],[0,0],[-12,0]],
        [[10,-3],[5,-7],[1,-10]],
