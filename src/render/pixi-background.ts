...
export function destroyPixiBackground(): void {
  ...
  farStarContainer = null;
  midStarContainer = null;
  nearStarContainer = null;
  dustContainer = null;
  starTexture?.destroy(true);
  _dustTex?.destroy(true);
  starTexture = null;
  _dustTex = null;
  currentSysIdx = -1;
  _lastWc = 0;
